%==============================================================================
% Business Analysis: Paper Bedrijfscase
%==============================================================================
...
\assignmenttype{Paper: Bedrijfscase}
...
\author{Neal Joos}
\email{neal.joos@student.hogent.be}
...
\email{xander.dheedene@student.hogent.be}
...
\keywords{Business Analysis, Bedrijfscase}
...
\begin{titlepage}
  \begin{center}
      ...
      {\huge \textbf{Wat als een klein team agile wil werken aan meerdere projecten?}}
      ...
      \begin{center}
        \includegraphics[width=3cm]{./img/HOGENT_Logo_Pos_rgb.png}
      \end{center}
